...
export function ContactForm({ onSuccess }: ContactFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6" data-testid="contact-form">
      ...
      />
      {errors.name && <div data-testid="name-error" className="text-red-600 text-sm">{errors.name}</div>}
      ...
      />
      {errors.email && <div data-testid="email-error" className="text-red-600 text-sm">{errors.email}</div>}
      ...
      />
      {errors.message && <div data-testid="message-error" className="text-red-600 text-sm">{errors.message}</div>}
